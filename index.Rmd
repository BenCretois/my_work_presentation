...
* Is there any seasonal differences?
...
* We hypothesize roe deer distribution not to be so different from Citizen Science observations

--

* For moose, this could be another story ...
...
* I would use a wide range of dataset including TOV-E data, Hunting dataset ...

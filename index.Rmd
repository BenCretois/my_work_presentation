...
knitr::include_graphics('imgs/waveform.PNG')
```
]

.center[
```{r, echo = FALSE, out.width="350px"}
knitr::include_graphics('imgs/spectrogram.PNG')
```
]
...
knitr::include_graphics('imgs/audio_to_classification.PNG')
```
]
...
.center[
```{r, echo = FALSE, out.width="400px"}
knitr::include_graphics('imgs/pytorch.jpeg')
```
]
